...
const textbubble_scene: PackedScene = preload("res://dialog_customs/styles/custom_textbubble/custom_text_bubble.tscn")
...
func bubble_apply_overrides(bubble:TextBubble) -> void:
	...
	var background := (bubble.get_node('%Background') as TextureRect)
